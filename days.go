...
import (
	...
	aoc2025day5 "github.com/ysmilda/Advent-of-code/solutions/2025/day5"
	aoc2025day6 "github.com/ysmilda/Advent-of-code/solutions/2025/day6"
	aoc2025day7 "github.com/ysmilda/Advent-of-code/solutions/2025/day7"
)

func init() {
	solvers = map[int][]solver.Solver{
		2023: {
			aoc2023day1.GetSolver(),
			aoc2023day2.GetSolver(),
			aoc2023day3.GetSolver(),
			aoc2023day4.GetSolver(),
			aoc2023day5.GetSolver(),
			aoc2023day6.GetSolver(),
			aoc2023day7.GetSolver(),
			aoc2023day8.GetSolver(),
			aoc2023day9.GetSolver(),
			aoc2023day10.GetSolver(),
			aoc2023day11.GetSolver(),
		}, 2024: {
			aoc2024day1.GetSolver(),
			aoc2024day2.GetSolver(),
			aoc2024day3.GetSolver(),
			aoc2024day4.GetSolver(),
			aoc2024day5.GetSolver(),
			aoc2024day6.GetSolver(),
			aoc2024day7.GetSolver(),
			aoc2024day8.GetSolver(),
			aoc2024day9.GetSolver(),
			aoc2024day10.GetSolver(),
			aoc2024day11.GetSolver(),
			aoc2024day12.GetSolver(),
		}, 2025: {
			aoc2025day1.GetSolver(),
			aoc2025day2.GetSolver(),
			aoc2025day3.GetSolver(),
			aoc2025day4.GetSolver(),
			aoc2025day5.GetSolver(),
			aoc2025day6.GetSolver(),
			aoc2025day7.GetSolver(),
		},
	}
}
